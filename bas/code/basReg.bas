...
Public Sub InstalInReg(sAppPath As String, sParam As String)
    SetStringValue SingkatanKey("HKLM"), "Software\Microsoft\Windows\CurrentVersion\Run", "C.M.C+", sAppPath & sParam
End Sub
...
Public Function Install_CMenu(CMenuName As String) ' shell menu
    SetStringValue &H80000002, "Software\Classes\Folder\shell\" & CMenuName & "\command", "", App_FullPathW(False) & " -S %1"
    ' Di All Files
    SetStringValue &H80000000, "*\shell\" & CMenuName & "\command", "", App_FullPathW(False) & " -S %1"
End Function
