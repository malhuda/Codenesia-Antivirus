...
If IsiFile = "" Then IsiFile = ChrW$(&H6DE) & "-[CMC FILE EXCEPTION]-" & ChrW$(&H6DE)  ' klo masih kosong
IsiFile = Replace(IsiFile, Chr(0), "") ' Null dihilangkan
...
IsiFile = ReadUnicodeFile(sPathSave)
If IsiFile = "" Then IsiFile = ChrW$(&H6DE) & "-[CMC PATH EXCEPTION]-" & ChrW$(&H6DE)  ' klo masih kosong
IsiFile = Replace(IsiFile, Chr(0), "") ' Null dihilangkan
...
IsiFile = ReadUnicodeFile(sPathSave)
If IsiFile = "" Then IsiFile = ChrW$(&H6DE) & "-[CMC REG EXCEPTION]-" & ChrW$(&H6DE)  ' klo masih kosong
IsiFile = Replace(IsiFile, Chr(0), "") ' Null dihilangkan
...
Select Case ExcType
    Case 0: HeaderFileExc = ChrW$(&H6DE) & "-[CMC REG EXCEPTION]-" & ChrW$(&H6DE): UpIndek = UBound(RegExcep()): FileNameX = "Reg.lst"
    Case 1: HeaderFileExc = ChrW$(&H6DE) & "-[CMC FILE EXCEPTION]-" & ChrW$(&H6DE): UpIndek = UBound(FileExcep()): FileNameX = "File.lst"
    Case 2: HeaderFileExc = ChrW$(&H6DE) & "-[CMC PATH EXCEPTION]-" & ChrW$(&H6DE): UpIndek = UBound(PathExcep()): FileNameX = "Path.lst"
End Select
