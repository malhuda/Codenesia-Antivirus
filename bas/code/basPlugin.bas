...
Option Explicit
'********************************************************************************'
'---ini adalah modul simpel untuk me-manage (mengatur) plugin dalam sebuah program.
'---plugin ini difokuskan pada keakuratan informasi yg ingin disampaikan, juga
'---menjaga agar hanya plugin tertentu yang telah divalidasi yg dapat dipakai.
'---ohya,plugin ini semua deklarasi,tipe,konstanta bersifat private,...stabil.
'---revisi:
'---sd 17 januari 2010:
